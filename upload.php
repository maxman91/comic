...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/comic/assets/images/profile_pics';
	//Set File name	
...
<html>
<head>
	<title>Upload Profile Pic! | KismatComics</title>
	<!-- Javascript -->
...
<div class="header">
		...
		<h2 class="instruction">Upload Profile Pic!</h4>
		</div>
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        ...
	        <input type="file" id="image" required name="image" style="width:200px; height:30px; " /><br /><br />
